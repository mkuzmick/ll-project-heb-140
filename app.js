...
// const friends = require("./src/bots/friends/index.js");
// const friendMarker = require("./src/bots/workers/friend-maker/index")
...
//   };
  ...
  let slackResult = await app.client.chat.postMessage({
    ...
    text: "starting up the heb140 work bots",
  });
